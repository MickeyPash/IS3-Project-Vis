...
public class OlympicScatterplotPanel extends JPanel implements ActionListener,
	...
	private JCheckBox middleEast, europe, africa, northAmerica, southAmerica,
			oceania, asia;
	...
	private String[] continents = new String[] { "Middle East", "Europe",
	...
	public OlympicScatterplotPanel(String data) {
		...
		JCheckBox[] colourBoxes = {
				middleEast = new JCheckBox(
						new ColouredCheckBoxIcon(colours[0]), true),
				europe = new JCheckBox(new ColouredCheckBoxIcon(colours[1]),
						true),
				africa = new JCheckBox(new ColouredCheckBoxIcon(colours[2]),
						true),
				northAmerica = new JCheckBox(new ColouredCheckBoxIcon(
						colours[3]), true),
				southAmerica = new JCheckBox(new ColouredCheckBoxIcon(
						colours[4]), true),
				oceania = new JCheckBox(new ColouredCheckBoxIcon(colours[5]),
						true),
	...
	private void changeColour(JCheckBox box, int colourPos) {
		if (box.isSelected())
			((ColouredCheckBoxIcon) box.getIcon())
					.setColour(colours[colourPos]);
		else
			((ColouredCheckBoxIcon) box.getIcon()).setColour(colours[7]);
